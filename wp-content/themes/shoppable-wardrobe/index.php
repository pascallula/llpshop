...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<!--Blog Vendors-->
			<?php get_template_part( 'template-parts/vendors/vendors' ); ?>

			<!--Blog Views-->
			<?php get_template_part( 'template-parts/views/views' ); ?>

			<!--Blog Featured Ad-->
			<?php get_template_part( 'template-parts/featured-ad/featured-ad' ); ?>
							...
							<?php
								if( get_theme_mod( 'enable_pagination', true ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'shoppable-wardrobe' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'shoppable-wardrobe' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'shoppable-wardrobe' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'shoppable-wardrobe' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'shoppable-wardrobe' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
