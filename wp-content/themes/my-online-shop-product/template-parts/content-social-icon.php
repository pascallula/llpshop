<?php
/**
 * Template part for displaying Social Icon from Customizer 
 *
...
<ul class="my-online-shop-social-media">
	<?php if(!empty($youtube_link)): ?>
		<li class="social-media-item">
			<a class="nav-link" href="<?php echo esc_url($youtube_link); ?>" target="_blank">
				<div class="social_media_button youtube">
	...
	<?php if(!empty($facebook_link)): ?>
		<li class="social-media-item">
			<a class="nav-link" href="<?php echo esc_url($facebook_link); ?>" target="_blank">
				<div class="social_media_button facebook">
	...
	<?php if(!empty($twitter_link)): ?>
		<li class="social-media-item">
			<a class="nav-link" href="<?php echo esc_url($twitter_link); ?>" target="_blank">
				<div class="social_media_button twitter">
	...
	<?php if(!empty($instagram_link)): ?>
		<li class="social-media-item">
			<a class="nav-link" href="<?php echo esc_url($instagram_link); ?>" target="_blank">
				<div class="social_media_button instagram">
	...
	<?php if(!empty($linked_link )): ?>
		<li class="social-media-item">
			<a class="nav-link" href="<?php echo esc_url($linked_link ); ?>" target="_blank">
				<div class="social_media_button linkedin">
