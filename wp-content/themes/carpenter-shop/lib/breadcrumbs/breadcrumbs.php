...
class Breadcrumb_Trail {
    ...
    protected function add_day_archive_items() {
        ...
        $carpenter_shop_year  = sprintf( $this->labels['archive_year'],  get_the_time( esc_html_x( 'Y', 'yearly archives date format',  'carpenter-shop' ) ) );
        $carpenter_shop_month = sprintf( $this->labels['archive_month'], get_the_time( esc_html_x( 'F', 'monthly archives date format', 'carpenter-shop' ) ) );
        $carpenter_shop_day   = sprintf( $this->labels['archive_day'],   get_the_time( esc_html_x( 'j', 'daily archives date format',   'carpenter-shop' ) ) );

        // Add the year and month items.
        $this->items[] = sprintf( '<a href="%s">%s</a>', esc_url( get_year_link( get_the_time( 'Y' ) ) ), $carpenter_shop_year );
        $this->items[] = sprintf( '<a href="%s">%s</a>', esc_url( get_month_link( get_the_time( 'Y' ), get_the_time( 'm' ) ) ), $carpenter_shop_month );

        // Add the day item.
        if ( is_paged() )
            $this->items[] = sprintf( '<a href="%s">%s</a>', esc_url( get_day_link( get_the_time( 'Y' ) ), get_the_time( 'm' ), get_the_time( 'd' ) ), $carpenter_shop_day );

        elseif ( true === $this->args['show_title'] )
            $this->items[] = $carpenter_shop_day;
    }
    ...
    protected function add_month_archive_items() {
        ...
        elseif ( true === $this->args['show_title'] )
            $this->items[] = $carpenter_shop_month;
    }
    ...
    protected function add_year_archive_items() {
        ...
        elseif ( true === $this->args['show_title'] )
            $this->items[] = $carpenter_shop_year;
    }
